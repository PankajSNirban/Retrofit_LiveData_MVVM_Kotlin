...
internal class TokyoCityAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, itemView: Int): TokyoCityAdapter.ParkItemsHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.tokyo_park_items, parent, false)
        return ParkItemsHolder(itemView)
    }

    override fun onBindViewHolder(holder: TokyoCityAdapter.ParkItemsHolder, position: Int) {
